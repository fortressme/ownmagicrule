...
|---|---|---|---|---|---|
| clash-rule.ini | 90 | 30 | 915 → **754** (−18%) | 162 → ~146 | 21 → 21 |
| clash-rule-black.ini | 90 | 30 | 915 → **754** (−18%) | 162 → ~146 | 21 → 21 |
| clash-rule-general.ini | 82 | 31 | 592 → **385** (−35%) | 128 → 126 | 7 → 5 |
...
| clash-rule-gocn.ini | 32 | 8 | 349 → **337** (−3%) | 34 → 32 | 24 → 24 |
...
| 灾备/过境低延去自建 | ~24 | N转直×11、北场D×4 退出多个商业池（XX-L 落地保留在池中，见 current-topology 注） |
| 合计 | ~193 | 与实测差值 183 吻合（成员集重叠抵消） |
